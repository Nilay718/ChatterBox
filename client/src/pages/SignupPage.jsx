  ...
  return (
    <div className="min-h-screen flex items-center justify-center theme-bg p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full bg-accent-500/5 blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-80 h-80 rounded-full bg-primary-500/5 blur-3xl" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="theme-text-tertiary mt-2">Create your account to get started</p>
        </div>
